...
var findFiber = function (arg) {
  !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Missing injection for fiber findDOMNode') : _prodInvariant('146') : void 0;
};
var findStack = function (arg) {
  !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Missing injection for stack findDOMNode') : _prodInvariant('147') : void 0;
};
