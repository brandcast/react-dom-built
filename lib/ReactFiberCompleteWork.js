...
var popContextProvider = _require2.popContextProvider;
...
module.exports = function (config) {
  ...
  function markCallback(workInProgress) {
  ...
  function completeWork(current, workInProgress) {
    switch (workInProgress.tag) {
      ...
      case ClassComponent:
        ...
        if (current) {
          if (current.memoizedProps !== workInProgress.memoizedProps || current.memoizedState !== workInProgress.memoizedState || updateQueue && updateQueue.isForced) {
      ...
      case HostComponent:
        ...
        if (current && workInProgress.stateNode != null) {
          ...
          var _instance = createInstance(workInProgress.type, newProps, children, workInProgress);
