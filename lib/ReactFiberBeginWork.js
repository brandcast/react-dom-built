...
var getMaskedContext = _require2.getMaskedContext;
var isContextProvider = _require2.isContextProvider;
var hasContextChanged = _require2.hasContextChanged;
var pushContextProvider = _require2.pushContextProvider;
var resetContext = _require2.resetContext;
...
module.exports = function (config, scheduleUpdate) {
  ...
  */
  ...
  function beginWork(current, workInProgress, priorityLevel) {
    ...
    if ((workInProgress.pendingProps === null || workInProgress.memoizedProps !== null && workInProgress.pendingProps === workInProgress.memoizedProps) && workInProgress.updateQueue === null && !hasContextChanged()) {
      return bailoutOnAlreadyFinishedWork(current, workInProgress);
    }
